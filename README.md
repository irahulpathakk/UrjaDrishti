...
```mermaid
graph LR
    subgraph External_Telemetry ["External Telemetry"]
        W["Open-Meteo Realtime API<br/>Delhi 28.61°N, 77.21°E"]
    end

    subgraph Backend_Services ["Backend Services (:8001)"]
    ...
    subgraph Frontend_Control_Desk ["Frontend Control Desk (:5173)"]
